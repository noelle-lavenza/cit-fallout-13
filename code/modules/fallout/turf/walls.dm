...
/turf/closed/wall/r_wall/f13/vault/rusted
...
/turf/closed/indestructible/f13/vault/rusted
	name = "rusty vault wall"
	desc = "A rusty chunk of metal used to separate rooms."
	...
	smooth = SMOOTH_TRUE
	canSmoothWith = list(/turf/closed/wall,/turf/closed/wall/r_wall,/obj/structure/falsewall,/obj/structure/falsewall/brass,/obj/structure/falsewall/reinforced,/turf/closed/wall/rust,/turf/closed/wall/r_wall/rust,/turf/closed/wall/clockwork,/turf/closed/indestructible/f13/vault/rusted)
