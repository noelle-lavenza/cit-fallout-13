...
/datum/job/vault/f13overseer
	...
	total_positions = 1
	spawn_positions = 1
	custom_spawn_text = "You are the leader of the Vault, and your word is law. Working with the Security team and your fellow Vault Dwellers, your goal is to ensure the continued prosperity and survival of the vault, through any and all means necessary."
...
/datum/job/vault/f13doctor
	...
	total_positions = 2
	spawn_positions = 2
	custom_spawn_text = "You answer directly to the Overseer. You are tasked with providing medical care to Vault Dwellers and ensuring the medical well-being of everyone in the Vault."
	supervisors = "the Overseer"
...
/datum/job/vault/f13vaultscientist
	...
	total_positions = 2
	spawn_positions = 2
	custom_spawn_text = "You answer directly to the Overseer. You are tasked with researching new technologies, conducting mining expeditions (with the approval of Security or the Overseer), and upgrading the machinery of the Vault."
	supervisors = "the Overseer"
	selection_color = "#ddffdd"
...
/datum/outfit/job/vault/f13security
	...
	uniform = 		/obj/item/clothing/under/f13/vault13
	head = 			/obj/item/clothing/head/helmet/riot/f13/vaultsec
...
/datum/job/vault/f13vaultengineer
	...
	total_positions = 2
	spawn_positions = 2
	custom_spawn_text = "You answer directly to the Overseer. You are tasked with overseeing the Reactor, maintaining Vault defenses and machinery, and engaging in construction projects to improve the Vault as a whole."
	supervisors = "the Overseer"
	selection_color = "#ddffdd"
...
/datum/job/vault/f13vaultDweller
	...
	total_positions = 8
	spawn_positions = 8
	custom_spawn_text = "You answer directly to the Overseer, being assigned to fulfill whatever menial tasks are required. You lack an assignment, but may be given one the Overseer if required or requested. You should otherwise busy yourself with assisting personnel with tasks around the Vault."
