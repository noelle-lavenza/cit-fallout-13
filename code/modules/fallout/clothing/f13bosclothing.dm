...
/obj/item/clothing/head/helmet/f13/combat/brotherhood
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 45, "bomb" = 60, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30)
...
/obj/item/clothing/head/helmet/f13/combat/brotherhood/captain
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 45, "bomb" = 60, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30)
...
/obj/item/clothing/head/helmet/f13/combat/brotherhood/scout/senior
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 45, "bomb" = 60, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30)
...
/obj/item/clothing/head/helmet/f13/combat/brotherhood/outcast
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 45, "bomb" = 60, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30)
...
/obj/item/clothing/head/f13/boscap
	...
	icon_state = "boscap"
	armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 0)
	strip_delay = 20
...
/obj/item/clothing/head/f13/boscap/lancer
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 0, "bomb" = 16, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
...
/obj/item/clothing/suit/f13/scribe
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 0, "bomb" = 16, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/toggle/labcoat/f13/fieldscribe
	...
	body_parts_covered = CHEST|ARMS|LEGS
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 0, "bomb" = 16, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
...
/obj/item/clothing/suit/f13/elder
	...
	icon_state = "elder"
	body_parts_covered = CHEST|ARMS|LEGS
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 0, "bomb" = 16, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/combatbosrein
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 45, "bomb" = 55, "bio" = 65, "rad" = 10, "fire" = 60, "acid" = 20)
