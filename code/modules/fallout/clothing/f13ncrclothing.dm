...
/obj/item/clothing/head/f13/ncr
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
	strip_delay = 50
...
/obj/item/clothing/head/beret/f13/ncr_lt
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/f13/ncr_campaign
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/beret/f13/ncr_dresscap
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/beret/f13/ncr_sof
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/mantle/reinforced
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 20, "bomb" = 30, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/captain
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 20, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/f13/ranger/sergeant
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 50, "bomb" = 39, "bio" = 60, "rad" = 60, "fire" = 90, "acid" = 0)
	actions_types = list(/datum/action/item_action/toggle)
...
/obj/item/clothing/head/helmet/f13/ncr/rangercombat
	...
	icon_state = "ranger"
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 50, "bomb" = 39, "bio" = 60, "rad" = 60, "fire" = 90, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/rangercombat/sergeant
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 40, "bomb" = 55, "bio" = 60, "rad" = 60, "fire" = 90, "acid" = 20)
...
/obj/item/clothing/suit/armor/f13/rangercombat
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 40, "bomb" = 55, "bio" = 60, "rad" = 60, "fire" = 90, "acid" = 20)
	slowdown = -0.1
...
/obj/item/clothing/suit/armor/f13/ncrcfjacket
	...
	armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 0, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
