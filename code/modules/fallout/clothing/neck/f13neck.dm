/obj/item/clothing/neck/f13
	icon = 'icons/fallout/clothing/neck.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothing/neck.dmi'

/obj/item/clothing/neck/f13/scarf/cptpatriot
	name = "desert scarf"
	icon_state = "cptpatriotscarf"
	desc = "A stylish scarf. This one has a camoflage pattern popularized during the great war."

/obj/item/clothing/neck/f13/corditeclamp
