...
/obj/item/clothing/head/helmet/f13/legion
	...
	lefthand_file = ""
	righthand_file = ""
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 10, "bomb" = 16, "bio" = 30, "rad" = 20, "fire" = 50, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/recruit/scout
	...
	icon_state = "legscout"
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 10, "bomb" = 16, "bio" = 30, "rad" = 20, "fire" = 50, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/prime
	...
	icon_state = "legprime"
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 15, "bomb" = 25, "bio" = 40, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/prime/explorer
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 15, "bomb" = 25, "bio" = 40, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/prime/slavemaster
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 20, "bomb" = 25, "bio" = 40, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/vet
	...
	icon_state = "legvet"
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/recruit/decan
	...
	icon_state = "legdecan"
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/prime/decan
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/vet/vexil
	...
	icon_state = "legvexil"
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/centurion
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 35, "bomb" = 39, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/rangercent
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 35, "bomb" = 39, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0)
	resistance_flags = LAVA_PROOF | FIRE_PROOF
...
/obj/item/clothing/head/helmet/f13/legion/palacent
	...
	icon_state = "palacent"
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 35, "bomb" = 39, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0)
	resistance_flags = LAVA_PROOF | FIRE_PROOF
...
/obj/item/clothing/head/helmet/f13/legion/legate
	...
	armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 40, "bomb" = 45, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/heavy
	...
	icon_state = "legheavy"
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 15, "bomb" = 25, "bio" = 60, "rad" = 20, "fire" = 75, "acid" = 10)
...
/obj/item/clothing/suit/armor/f13/legion/palacent
	...
	icon_state = "palacent"
	slowdown = 0
	armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 40, "bomb" = 39, "bio" = 60, "rad" = 30, "fire" = 80, "acid" = 10)
...
/obj/item/clothing/suit/armor/f13/legion/rangercent
	...
	icon_state = "rangercent"
	slowdown = -0.20
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 25, "bomb" = 39, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0)
