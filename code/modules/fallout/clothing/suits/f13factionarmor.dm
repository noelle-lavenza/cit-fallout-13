...
/obj/item/clothing/suit/armor/f13/raider/leather_jacket
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 20, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25)
...
/obj/item/clothing/suit/armor/f13/raider/raidercombat
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 30, "bomb" = 50, "bio" = 50, "rad" = 10, "fire" = 60, "acid" = 10)
...
/obj/item/clothing/suit/armor/f13/raider/raidermetal
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 35, "bomb" = 50, "bio" = 50, "rad" = 10, "fire" = 60, "acid" = 10)
...
/obj/item/clothing/suit/armor/f13/town/sheriff
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 40, "bomb" = 25, "bio" = 40, "rad" = 40, "fire" = 80, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/riot/vault/scout
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 30, "bomb" = 25, "bio" = 30, "rad" = 10, "fire" = 50, "acid" = 10)
	slowdown = -0.13
...
/obj/item/clothing/suit/armor/f13/riot/vault/heavy
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 40, "bomb" = 40, "bio" = 30, "rad" = 15, "fire" = 65, "acid" = 30)
...
/obj/item/clothing/suit/armor/f13/riot/vault/provost
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 20, "bomb" = 60, "bio" = 30, "rad" = 15, "fire" = 65, "acid" = 30)
...
/obj/item/clothing/suit/armor/f13/riot/vault/provost/marshal
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 20, "bomb" = 60, "bio" = 30, "rad" = 15, "fire" = 65, "acid" = 30)
...
/obj/item/clothing/suit/armor/f13/gunnerplates
	...
	icon = 'icons/fallout/clothing/suits.dmi'
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 45, "bomb" = 55, "bio" = 65, "rad" = 10, "fire" = 60, "acid" = 20)
...
/obj/item/clothing/suit/armor/f13/caeserpelt
	...
	armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 45, "bomb" = 55, "bio" = 65, "rad" = 10, "fire" = 60, "acid" = 20)
...
/obj/item/clothing/suit/armor/f13/rangercombat/old
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 20, "bomb" = 20, "bio" = 0, "rad" = 30, "fire" = 20, "acid" = 20)
	icon = 'icons/fallout/clothing/suits.dmi'
...
/obj/item/clothing/suit/armor/f13/rangercombat/eliteriot
	...
	armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 60, "bomb" = 70, "bio" = 60, "rad" = 60, "fire" = 90, "acid" = 50)
	icon = 'icons/fallout/clothing/suits.dmi'
...
/obj/item/clothing/suit/armor/f13/rangercombat/eliteriot/reclaimed
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 30, "bomb" = 30, "bio" = 30, "rad" = 30, "fire" = 30, "acid" = 30)
	icon = 'icons/fallout/clothing/suits.dmi'
...
/obj/item/clothing/suit/armor/f13/ncrarmor/facewrap
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 10, "bomb" = 20, "bio" = 0, "rad" = 30, "fire" = 10, "acid" = 10) //Better radiation protection, thank the facewrap bro!
	icon = 'icons/fallout/clothing/suits.dmi'
