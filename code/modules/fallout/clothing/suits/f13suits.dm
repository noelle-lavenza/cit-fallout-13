...
/obj/item/clothing/suit/f13/vest
	...
	armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 0, "bomb" = 16, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/f13/battlecruiser //Do we have Star Craft here as well?!
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 10, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 0)
...
/obj/item/clothing/suit/f13/mfp //Mad Max 1 1979 babe!
	...
	icon_state = "mfp"
	item_state = "hostrench"
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 0)
...
/obj/item/clothing/suit/f13/lonesome
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 10, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
...
/obj/item/clothing/suit/f13/duster
	...
	icon_state = "duster"
	item_state = "det_suit"
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 0, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/f13/sheriff
	...
	icon_state = "sheriff"
	item_state = "det_suit"
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
...
/obj/item/clothing/suit/f13/autumn //Based of Colonel Autumn's uniform.
	...
	icon_state = "autumn"
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 20, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/toggle/labcoat/f13/warriors
	...
	icon_state = "warriors"
	item_state = "owl"
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/toggle/labcoat/f13/khan_jacket
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 25, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25)
...
/obj/item/clothing/suit/toggle/labcoat/f13/khan_jacket_armored
	...
	icon_state = "khan_jacket"
	item_state = "jensencoat"
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 35, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25)
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS|HANDS
...
/obj/item/clothing/suit/toggle/labcoat/f13/khan/battlecoat
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 35, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25)
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS|HANDS
...
/obj/item/clothing/suit/toggle/labcoat/f13/followers
	...
	item_state = "labcoat"
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 10, "bomb" = 0, "bio" = 10, "rad" = 10, "fire" = 10, "acid" = 10)
...
/obj/item/clothing/suit/toggle/labcoat/f13/ncrbomber
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 10, "fire" = 10, "acid" = 10)
...
/obj/item/clothing/suit/hooded/f13/cloak/goliath
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 20, "bomb" = 40, "bio" = 30, "rad" = 10, "fire" = 60, "acid" = 20)
...
/obj/item/clothing/head/hooded/f13/cloakhood/goliath
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 15, "bomb" = 25, "bio" = 0, "rad" = 10, "fire" = 60, "acid" = 20)
	flags_inv = HIDEEARS|HIDEEYES|HIDEHAIR|HIDEFACIALHAIR
...
/obj/item/clothing/suit/hooded/f13/parka/medical
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 60, "acid" = 60)
...
/obj/item/clothing/suit/hooded/f13/cloak/goliath/tatteredred
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 30)
...
/obj/item/clothing/suit/hooded/f13/cloak/birdarmor
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 20, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
