...
/obj/item/clothing/suit/armor/f13/leather_jacket
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/leather_jacket/combat
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 20, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25)
...
/obj/item/clothing/suit/armor/f13/leather_jacket/combat/coat
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 35, "bomb" = 45, "bio" = 30, "rad" = 5, "fire" = 50, "acid" = 35)
...
/obj/item/clothing/suit/armor/f13/kit
	...
	icon_state = "armorkit"
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 15, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
	strip_delay = 30
...
/obj/item/clothing/suit/armor/f13/leatherarmor
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 25, "bomb" = 32, "bio" = 0, "rad" = 10, "fire" = 30, "acid" = 35)
	strip_delay = 40
...
/obj/item/clothing/suit/armor/f13/leatherarmor/reinforced
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 30, "bomb" = 35, "bio" = 0, "rad" = 15, "fire" = 40, "acid" = 35)

/obj/item/clothing/suit/armor/f13/metalarmor
	name = "metal armor"
	desc = "(IV) A set of plates formed together to form a crude chestplate."
	icon_state = "metal_chestplate"
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 40, "bomb" = 40, "bio" = 30, "rad" = 15, "fire" = 60, "acid" = 0)
	slowdown = 0.25
	strip_delay = 10
...
/obj/item/clothing/suit/armor/f13/metalarmor/reinforced
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 50, "bomb" = 40, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
	slowdown = 0.05
	strip_delay = 10
...
/obj/item/clothing/suit/armor/f13/combat/mk2
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 45, "bomb" = 55, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30)
...
/obj/item/clothing/suit/armor/f13/combat/swat
	...
	icon_state = "armoralt"
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 45, "bomb" = 55, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30)
...
/obj/item/clothing/suit/armor/f13/combat/chinese
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 40, "bomb" = 60, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 10)
...
/obj/item/clothing/suit/armor/f13/combatrusted
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 38, "bomb" = 48, "bio" = 58, "rad" = 10, "fire" = 58, "acid" = 18)
...
/obj/item/clothing/suit/armor/f13/combat/marine
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50,"energy" = 45, "bomb" = 55, "bio" = 70, "rad" = 60, "fire" = 60, "acid" = 50)
...
/obj/item/clothing/suit/armor/f13/ahp_suit
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 35, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25)
	strip_delay = 40
...
/obj/item/clothing/suit/armor/f13/power_armor/t45b
	...
	armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 50, "bomb" = 48, "bio" = 60, "rad" = 50, "fire" = 80, "acid" = 0, "wound" = 40)
...
/obj/item/clothing/suit/armor/f13/power_armor/vaulttec
	...
	icon_state = "vaultpa"
	armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 50, "bomb" = 48, "bio" = 60, "rad" = 50, "fire" = 80, "acid" = 0)
	slowdown = 0
...
/obj/item/clothing/suit/armor/f13/power_armor/vaulttec/ta
	...
	armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 30, "bomb" = 38, "bio" = 40, "rad" = 20, "fire" = 100, "acid" = 0)
	slowdown = 0.4
...
/obj/item/clothing/suit/armor/f13/power_armor/excavator
	...
	armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 60, "bomb" = 62, "bio" = 100, "rad" = 90, "fire" = 90, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/power_armor/t45d
	...
	slowdown = 0.24
	armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 60, "bomb" = 62, "bio" = 100, "rad" = 90, "fire" = 90, "acid" = 0, "wound" = 60)
...
/obj/item/clothing/suit/armor/f13/power_armor/midwest
	...
	armor = list("melee" = 60, "bullet" = 60, "laser" = 60, "energy" = 60, "bomb" = 62, "bio" = 100, "rad" = 90, "fire" = 90, "acid" = 0, "wound" = 60)
...
/obj/item/clothing/suit/armor/f13/power_armor/t51b
	...
	armor = list("melee" = 60, "bullet" = 60, "laser" = 60, "energy" = 65, "bomb" = 62, "bio" = 100, "rad" = 99, "fire" = 90, "acid" = 0, "wound" = 70)
...
/obj/item/clothing/suit/armor/f13/power_armor/t51b/tesla
	...
	icon_state = "t51tesla"
	slowdown = 0.15 //+0.1 from helmet = total 0.25
	armor = list("melee" = 65, "bullet" = 65, "laser" = 65, "energy" = 70, "bomb" = 62, "bio" = 100, "rad" = 99, "fire" = 90, "acid" = 0, "wound" = 70)
...
/obj/item/clothing/suit/armor/f13/power_armor/advanced
	...
	armor = list("melee" = 75, "bullet" = 75, "laser" = 75, "energy" = 75, "bomb" = 72, "bio" = 100, "rad" = 100, "fire" = 90, "acid" = 0, "wound" = 90)
...
/obj/item/clothing/suit/armor/f13/power_armor/advanced/mk2
	...
	armor = list("melee" = 80, "bullet" = 80, "laser" = 80, "energy" = 90, "bomb" = 72, "bio" = 100, "rad" = 100, "fire" = 90, "acid" = 0, "wound" = 100)
...
/obj/item/clothing/suit/armor/f13/power_armor/tesla
	...
	icon_state = "tesla"
	armor = list("melee" = 60, "bullet" = 60, "laser" = 75, "energy" = 95, "bomb" = 62, "bio" = 100, "rad" = 100, "fire" = 90, "acid" = 0, "wound" = 80)
...
/obj/item/clothing/suit/armor/f13/power_armor/mutie
	...
	armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 50, "bomb" = 48, "bio" = 0, "rad" = 0, "fire" = 80, "acid" = 0, "wound" = 40)
	slowdown = 0.4
	requires_training = FALSE
...
/obj/item/clothing/suit/armor/f13/tribal
	...
	icon_state = "tribal"
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
	flags_inv = HIDEJUMPSUIT
	strip_delay = 40
	icon = 'icons/fallout/clothing/suits.dmi'
...
/obj/item/clothing/suit/armor/f13/chitinarmor
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 25, "bomb" = 25, "bio" = 70, "rad" = 65, "fire" = 80, "acid" = 100)
	flags_inv = HIDEJUMPSUIT
	strip_delay = 40
...
/obj/item/clothing/suit/armor/f13/tesla //changed from armor/laserproof
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 60, "bomb" = 40, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/toggle/armor
	...
	max_integrity = 250
	resistance_flags = NONE
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 16, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50)
	togglename = "collar"
...
/obj/item/clothing/suit/armor/f13/vaquero
	...
	icon_state = "vaquero"
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 10, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0)
	flags_inv = HIDEJUMPSUIT
...
/obj/item/clothing/suit/armor/f13/slam
	...
	icon_state = "slam"
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
	flags_inv = HIDEJUMPSUIT
	strip_delay = 40
	icon = 'icons/fallout/clothing/suits.dmi'
...
/obj/item/clothing/suit/armor/f13/battlecoat //Maxson's battlecoat from Fallout 4
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 30, "bio" = 0, "rad" = 30, "fire" = 30, "acid" = 30)
	strip_delay = 30
	icon = 'icons/fallout/clothing/suits.dmi'
...
/obj/item/clothing/suit/armor/f13/battlecoat/vault/armoured
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 35, "bomb" = 35, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
...
/obj/item/clothing/suit/armor/f13/battlecoat/vault/armoured/roadie/fast
	...
	icon_state = "roadie_battlecoat"
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 35, "bomb" = 35, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
	slowdown = -0.10
...
/obj/item/clothing/suit/toggle/armor/f13/cloakranger //Reskinned trail ranger gear
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0) //Same armor as trail ranger gear
...
/obj/item/clothing/suit/armor/f13/atomzealot
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 35, "bomb" = 30, "bio" = 0, "rad" = 100,"fire" = 25, "acid" = 25)
...
/obj/item/clothing/suit/armor/f13/mutie/poncho
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 40, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20)
...
/obj/item/clothing/suit/armor/f13/mutie/metal/heavy
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 40, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20)
...
/obj/item/clothing/suit/armor/f13/mutie/metal/reinforced
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 40, "bomb" = 50, "bio" = 60, "rad" = 40, "fire" = 30, "acid" = 20)
