...
/obj/item/clothing/head/helmet/f13/rangerbroken
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 50, "bomb" = 39, "bio" = 20, "rad" = 20, "fire" = 30, "acid" = 0)
...
// Knight Helmets
/obj/item/clothing/head/helmet/knight/f13
	icon = 'icons/fallout/clothing/hats.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothing/head.dmi'
...
/obj/item/clothing/head/helmet/knight/f13/metal
	...
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 20, "bomb" = 16, "bio" = 0, "rad" = 0)
...
/obj/item/clothing/head/helmet/knight/f13/metal/reinforced
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 25, "bomb" = 16, "bio" = 0, "rad" = 0)
...
/obj/item/clothing/suit/armor/f13/power_armor/emp_act(mob/living/carbon/human/owner, severity)
	. = ..()
	if(. & EMP_PROTECT_SELF || emped || !ismob(loc))
		return
	...
	emped = TRUE
	addtimer(CALLBACK(src, .proc/emp_effect_end), 5 SECONDS) //5 seconds of being slow and weak

/obj/item/clothing/suit/armor/f13/power_armor/proc/emp_effect_end()
...
/obj/item/clothing/head/helmet/f13/power_armor/tesla
	...
	icon_state = "tesla"
	armor = list("melee" = 65, "bullet" = 65, "laser" = 75, "energy" = 95, "bomb" = 62, "bio" = 100, "rad" = 100, "fire" = 90, "acid" = 0, "wound" = 80)
...
/obj/item/clothing/head/helmet/f13/power_armor/mutie
	...
	requires_training = FALSE
	armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 60, "bomb" = 50, "bio" = 30, "rad" = 0, "fire" = 90, "acid" = 0, "wound" = 60)
...
/obj/item/clothing/head/helmet/f13/tribal
	...
	icon_state = "tribal"
	flags_cover = HEADCOVERSEYES | HEADCOVERSMOUTH
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 10, "fire" = 0, "acid" = 0)
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
	strip_delay = 30
	dynamic_hair_suffix = ""
	dynamic_fhair_suffix = ""
...
/obj/item/clothing/head/helmet/f13/motorcycle
	...
	flags_cover = HEADCOVERSEYES
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "melee" = 20, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/firefighter
	...
	flags_cover = HEADCOVERSEYES | HEADCOVERSMOUTH
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 90, "acid" = 0)
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
	cold_protection = HEAD
	min_cold_protection_temperature = SPACE_HELM_MIN_TEMP_PROTECT
	heat_protection = HEAD
...
/obj/item/clothing/head/helmet/f13/vaquerohat
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 0)
	flags_inv = HIDEEARS|HIDEHAIR
...
/obj/item/clothing/head/helmet/f13/hoodedmask
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 20, "bomb" = 70, "bio" = 70, "rad" = 70, "fire" = 65, "acid" = 30)
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
	dynamic_hair_suffix = ""
	dynamic_fhair_suffix = ""
...
/obj/item/clothing/head/f13/police
	...
	item_state = "fedora"
	armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 0, "bomb" = 25, "bio" = 0, "rad" = 0)
	flags_inv = HIDEEARS|HIDEHAIR

/obj/item/clothing/head/f13/simplekitty
	name = "kitty headband"
...
/obj/item/clothing/head/donor/macarthur
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 20, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 20)
...
/obj/item/clothing/head/helmet/f13/jasonmask
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 20, "bomb" = 70, "bio" = 70, "rad" = 70, "fire" = 65, "acid" = 30)
...
/obj/item/clothing/head/welding/f13/fire
	...
	item_state = "welding"
	tint = 1
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 5, "bomb" = 5, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/atombeliever
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 25, "bomb" = 30, "bio" = 20, "rad" = 100, "fire" = 50, "acid" = 20)
...
/obj/item/clothing/head/f13/flatranger
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 30, "bomb" = 25, "bio" = 40, "rad" = 40, "fire" = 80, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/legion/venator/diohelmet
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/mutie
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 20, "bomb" = 28, "bio" = 0, "rad" = 0, "fire" = 80, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/mutie/knight
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 20, "bomb" = 28, "bio" = 0, "rad" = 0, "fire" = 80, "acid" = 0)
...
/obj/item/clothing/head/beret/f13/headband
	name = "red headband"
...
/obj/item/clothing/head/f13/Bikerhelmet
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 0)
	resistance_flags = FIRE_PROOF
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
...
/obj/item/clothing/head/helmet/riot/f13
	icon = 'icons/fallout/clothing/hats.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothing/head.dmi'

/obj/item/clothing/head/hardhat/f13
	icon = 'icons/fallout/clothing/hats.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothing/head.dmi'

/obj/item/clothing/head/beret/f13
	icon = 'icons/fallout/clothing/hats.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothing/head.dmi'
